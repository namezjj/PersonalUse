...
def process_abstracts():
    ...
    # File paths
    json_file = '/share/zj/ele_extract_zj/Li_metal_selection/abstract90657-2.json'
    output_csv = '/share/zj/ele_extract_zj/Li_metal_selection/true_dois3.csv'
    progress_file = '/share/zj/ele_extract_zj/Li_metal_selection/progress3.txt'
